...
- [X] T104 [quickstart.md](quickstart.md) 7장 완료 판정 항목을 **실제로 돌려** 전부 통과시킨다. SC-007(원인 파악 가능성)은 자동 검증이 불가능하므로 **수동 확인 항목**으로 남기고 결과를 적는다. 통과하지 못한 항목은 사유와 함께 남긴다 — 통과한 것처럼 보고하지 않는다
