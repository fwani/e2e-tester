...
export function StartingIndicator({
  ...
  return (
    ...
    >
      <Chip>STARTING</Chip>
      <p className="m-0 font-sans text-[14px] leading-[1.4] font-normal text-ink-2">
        {message}
      </p>
      {slow && (
        <p className="m-0 text-center font-sans text-[12px] leading-[1.4] font-normal text-ink-3">
