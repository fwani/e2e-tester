      ...
      */}
      ...
      {degradedReason !== null && (
        <div className="flex items-center bg-sunken-2 gap-s2 py-[6px] px-[14px]">
          ...
          */}
          {controllable && <span className="font-sans text-[12px] leading-[1.4] font-normal text-ink-3">{MIRROR_DEGRADED_WARNING}</span>}
          {/*
      ...
      <div className="flex items-center gap-s2 py-[6px] px-[14px]">
        ...
        */}
        {!controllable && (
          <span className="font-sans text-[12px] leading-[1.4] font-normal text-ink-3" data-disabled-reason="mirror.control">
            {blockedReason}
          </span>
        )}
        {controllable && (
...
function UseWindowAction({
 ...
 <span className="flex items-center gap-[6px]">
      ...
      {disabled && (
        <span className="font-sans text-[12px] leading-[1.4] font-normal text-ink-3" data-disabled-reason="mirror.useWindow">
          {capability.reason}
        </span>
      )}
    </span>
