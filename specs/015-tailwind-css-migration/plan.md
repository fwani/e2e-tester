...
의미 클래스 109개는 React 부품 컴포넌트로, 배치 인라인 455곳은 유틸리티 클래스로.
...
**Scale/Scope**: `.tsx` 43개 · 의미 클래스 109개 · 배치 인라인 455곳 ·
...
│   └── class-migration.md       # 의미 클래스 109개 행선지 대응표 (SC-009)
├── checklists/
│   └── requirements.md
...
새로 만드는 디렉터리는 `frontend/src/ui/` 하나뿐이며, 이것이 해체된 의미 클래스 109개의
...
| **2. 부품** | 의미 클래스 109개 → `ui/` 컴포넌트. 한 부품씩 | 대응표 「미완료」 0건. `tokens.css` 에 부품 클래스 0개 |
