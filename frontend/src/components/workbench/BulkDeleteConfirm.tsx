  ...
  return (
    <div
      ...
      className={
        ...
        "bg-warn-t border border-warn-line rounded-base font-sans text-[14px] leading-[1.4] font-normal " +
        "flex items-center gap-[10px] py-s2 px-s3 mb-[10px]"
      }
    >
      <span className="font-sans text-[14px] font-semibold leading-none">{deleteManyConfirm(indices)}</span>
      {!revertible && (
        <span data-bulk-delete-irreversible className="font-sans text-[12px] leading-[1.4] font-normal text-ink-3">
