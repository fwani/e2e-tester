  ...
  return (
    <div className="bg-panel border border-hair rounded-base p-s3 flex flex-col gap-[10px]">
      <div className="flex items-center gap-s2">
        <strong className="font-sans text-[12px] font-semibold leading-[1.4] text-ink-2">{atLabel} 앞에 추가</strong>
      ...
      {!usable && capability.kind === "disabled" && (
        <div className="font-sans text-[12px] leading-[1.4] font-normal text-ink-3" role="status">
          {capability.reason}
        </div>
      )}
      ...
      */}
      ...
      {(kind === "navigate" || kind === "assert_url") && (
        <label className="flex flex-col gap-s1">
          <span className="font-sans text-[12px] font-semibold leading-[1.4] text-ink-2">주소</span>
          <Input
            aria-label="주소"
            font="mono"
            value={url}
      ...
      {kind === "assert_text" && (
        <label className="flex flex-col gap-s1">
          <span className="font-sans text-[12px] font-semibold leading-[1.4] text-ink-2">기대 텍스트</span>
          <Input
            aria-label="기대 텍스트"
            value={text}
            disabled={!usable}
      ...
      {kind === "close_tab" && (
        <label className="flex flex-col gap-s1">
          <span className="font-sans text-[12px] font-semibold leading-[1.4] text-ink-2">탭 번호</span>
          <Input
      ...
      {ready && (
        <div className="font-sans text-[12px] leading-[1.4] font-normal text-ink-3" aria-label="넣을 Step 미리보기">
      ...
      <div className="border-t border-hair pt-[10px] flex flex-col gap-[6px]">
        ...
        {browserCapability.kind === "disabled" && (
          <div className="font-sans text-[12px] leading-[1.4] font-normal text-ink-3">{browserCapability.reason}</div>
        )}
      </div>
    </div>
  );
