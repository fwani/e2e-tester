...
export function InlineSecretInput({
  ...
  return (
    ...
    >
      <div className="font-sans text-[12px] font-semibold leading-[1.4] text-ink-2">비밀 값</div>
      ...
      {hasKey === false && (
        ...
        >
          <div className="font-sans text-[14px] leading-[1.4] font-normal mb-s2">
      ...
      <div>
        ...
        />
        {name !== "" && !nameOk && (
 <p className="font-sans text-[12px] leading-[1.4] font-normal text-fail mt-s1 mx-0 mb-0">
      ...
      {error !== null && (
        <p role="alert" className="font-sans text-[14px] leading-[1.4] font-normal text-fail m-0">
          {error}
        </p>
      )}
      {notice !== null && (
        <p role="status" className="font-sans text-[14px] leading-[1.4] font-normal text-ink-2 m-0">
          {notice}
        </p>
      )}
